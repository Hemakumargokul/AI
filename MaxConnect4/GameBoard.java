...
public class GameBoard 
{
	...
	if( !f.exists())
	{
		try {
		      ...
		      File file = new File(inputFile);
		      	...
		      	//Create new file
		      	file.createNewFile();
		        System.out.println("No input file existed, so new file is created!");
    ...
    public String eval( int player1 , int player2,int depth) 
    {
	//reset the scores
	int playerScore1 = 0;
	int playerScore2 = 0;
	...
	for( int i = 0; i < 6; i++ ) 
	    ...
	    {
	    	flag=0;
		if( ( this.playBoard[ i ][j] == player1 ) &&
		    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
		    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
		    ( this.playBoard[ i ][ j+3 ] == player1 ) ) 
		{
		    playerScore1=playerScore1+10;
		}
		    else if
			( ( this.playBoard[ i ][j] == player2 ) &&
				    ( this.playBoard[ i ][ j+1 ] == player2 ) &&
				    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
				    ( this.playBoard[ i ][ j+3 ] == player2 ) ) 
				{
		    ...
		    /*else if( (( this.playBoard[ i ][j] == 0 ) &&
				    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
				    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
				    ( this.playBoard[ i ][ j+3 ] == player1 ))  || (( this.playBoard[ i ][j] == player1 ) &&
		    ...
		    {
		    	playerScore1=playerScore1+4;
		    }
		    else if( (( this.playBoard[ i ][j] == 0 ) &&
				    ( this.playBoard[ i ][ j+1 ] == player2 ) &&
				    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
				    ( this.playBoard[ i ][ j+3 ] == player2 ))  || (( this.playBoard[ i ][j] == player2 ) &&
				    ( this.playBoard[ i ][ j+1 ] == 0 ) &&
				    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
				    ( this.playBoard[ i ][ j+3 ] == player2 )) || (( this.playBoard[ i ][j] == player2 ) &&
						    ( this.playBoard[ i ][ j+1 ] == player2 ) &&
				    ...
				    ( this.playBoard[ i ][ j+3 ] == 0 ))) 
		    {
		    	playerScore2=playerScore2+4;
		    }*/
		
		    else //check player1 2's
		    {	    
			    if( (( this.playBoard[ i ][j] == 0 ) &&
					    ( this.playBoard[ i ][ j+1 ] == 0 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ...
					    ( this.playBoard[ i ][ j+3 ] == player1 )) || (( this.playBoard[ i ][j] == player1 ) &&
							    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
							    ( this.playBoard[ i ][ j+2 ] == 0 ) &&
							    ( this.playBoard[ i ][ j+3 ] == 0 )) || (( this.playBoard[ i ][j] == 0 ) &&
					    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+3 ] == 0 ))) 
			    {
		    ...
		    //check for unblocking 3's //even depth 1 //odd depth 2
		if(flag==0) {    
		if(depth%2==0){
		    if(i==5)
		    {
		    ...
		    {
		    	if( (( this.playBoard[ i ][j] == 0 ) && (this.playBoard[ i+1 ][j] != 0 ) &&   ( this.playBoard[ i ][ j+1 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+3 ] == player1 ))  || (( this.playBoard[ i ][j] == player1 ) &&
					    ( this.playBoard[ i ][ j+1 ] == 0 ) && (this.playBoard[ i+1 ][j+1] != 0 ) && 
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+3 ] == player1 )) || (( this.playBoard[ i ][j] == player1 ) &&
							    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
							    ( this.playBoard[ i ][ j+2 ] == 0 ) && (this.playBoard[ i+1 ][j+2] != 0 ) &&
							    ( this.playBoard[ i ][ j+3 ] == player1 )) || (( this.playBoard[ i ][j] == player1 ) &&
					    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+3 ] == 0 ) && (this.playBoard[ i+1 ][j+3] != 0 ) )) 
			    {
			    	
		    		playerScore1=playerScore1+5;
			    }
		    	else if((( this.playBoard[ i ][j] == 0 )  &&   ( this.playBoard[ i ][ j+1 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
					    ( this.playBoard[ i ][ j+3 ] == player1 ))  || (( this.playBoard[ i ][j] == player1 ) &&
					    ( this.playBoard[ i ][ j+1 ] == 0 ) &&
					    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
		    ...
		    else//odd depth
		    {
			    ...
			    {
			    	if( (( this.playBoard[ i ][j] == 0 ) && (this.playBoard[ i+2 ][j] != 0 ) &&   ( this.playBoard[ i ][ j+1 ] == player1 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player1 ))  || (( this.playBoard[ i ][j] == player1 ) &&
						    ( this.playBoard[ i ][ j+1 ] == 0 ) && (this.playBoard[ i+2 ][j+1] != 0 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player1 )) || (( this.playBoard[ i ][j] == player1 ) &&
								    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
								    ( this.playBoard[ i ][ j+2 ] == 0 ) && (this.playBoard[ i+2 ][j+2] != 0 ) &&
								    ( this.playBoard[ i ][ j+3 ] == player1 )) || (( this.playBoard[ i ][j] == player1 ) &&
						    ( this.playBoard[ i ][ j+1 ] == player1 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player1 ) &&
						    ( this.playBoard[ i ][ j+3 ] == 0 ) && (this.playBoard[ i+2 ][j+3] != 0 ) )) 
				    {
				    	playerScore1=playerScore1+5;
				    }
			    	else if((( this.playBoard[ i ][j] == 0 )  &&   ( this.playBoard[ i ][ j+1 ] == player1 ) &&
	    ...
	    //}
			    ...
			    //check for unblocking 3's //even depth 2 //odd depth 1 //player 2
			    if(depth%2!=0){
			    if(i==5)
			    {
			    if( (( this.playBoard[ i ][j] == 0 ) &&
			    ...
			    {
			    	if( (( this.playBoard[ i ][j] == 0 ) && (this.playBoard[ i+1 ][j] != 0 ) &&   ( this.playBoard[ i ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player2 ))  || (( this.playBoard[ i ][j] == player2 ) &&
						    ( this.playBoard[ i ][ j+1 ] == 0 ) && (this.playBoard[ i+1 ][j+1] != 0 ) && 
						    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
			    	...
			    	else if((( this.playBoard[ i ][j] == 0 )  &&   ( this.playBoard[ i ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player2 ))  || (( this.playBoard[ i ][j] == player2 ) &&
						    ( this.playBoard[ i ][ j+1 ] == 0 ) &&
						    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
			    ...
			    else//even depth
			    {
				    ...
				    {
				    	if( (( this.playBoard[ i ][j] == 0 ) && (this.playBoard[ i+2 ][j] != 0 ) &&   ( this.playBoard[ i ][ j+1 ] == player2 ) &&
							    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
							    ( this.playBoard[ i ][ j+3 ] == player2 ))  || (( this.playBoard[ i ][j] == player2 ) &&
							    ( this.playBoard[ i ][ j+1 ] == 0 ) && (this.playBoard[ i+2 ][j+1] != 0 ) &&
							    ( this.playBoard[ i ][ j+2 ] == player2 ) &&
	...
	for( int i = 0; i < 3; i++ ) {
	    for( int j = 0; j < 7; j++ ) {
		if( ( this.playBoard[ i ][ j ] == player1 ) &&
		    ( this.playBoard[ i+1 ][ j ] == player1 ) &&
		    ( this.playBoard[ i+2 ][ j ] == player1 ) &&
		    ( this.playBoard[ i+3 ][ j ] == player1 ) ) {
			playerScore1=playerScore1+10;
			}
		else if( ( this.playBoard[ i ][ j ] == player2 ) &&
			    ( this.playBoard[ i+1 ][ j ] == player2 ) &&
			    ( this.playBoard[ i+2 ][ j ] == player2 ) &&
			    ( this.playBoard[ i+3 ][ j ] == player2 ) ) {
			playerScore2=playerScore2+10;
		}
		  //check for unblocking 3's
			    ...
			    }//check for unblocking 2's//opponent
		else   if( (( this.playBoard[ i ][j] == 0 ) &&
			  ...
			  //check for unblocking 3's//opponent
	...
	//check diagonally - backs lash ->	\
		...
		for( int j = 0; j < 4; j++ ) {
		    if( ( this.playBoard[ i ][ j ] == player1 ) &&
			( this.playBoard[ i+1 ][ j+1 ] == player1 ) &&
			( this.playBoard[ i+2 ][ j+2 ] == player1 ) &&
			( this.playBoard[ i+3 ][ j+3 ] == player1 ) ) {
		    	playerScore1=playerScore1+10;
			    
		    }
		    else if( ( this.playBoard[ i ][ j ] == player2 ) &&
					( this.playBoard[ i+1 ][ j+1 ] == player2 ) &&
					( this.playBoard[ i+2 ][ j+2 ] == player2 ) &&
					( this.playBoard[ i+3 ][ j+3 ] == player2 ) ) {
		    	playerScore2=playerScore2+10;
		  ...
		  //check for unblocking 3's
				    ...
				    ( this.playBoard[ i+1 ][ j+1 ] == player1 ) &&
				    ( this.playBoard[ i+2 ][ j+2 ] == player1 ) &&
				    ( this.playBoard[ i+3 ][ j+3 ] == player1 ))  || (( this.playBoard[ i ][j] == player1 ) &&
				    ...
				    ( this.playBoard[ i+3 ][ j+3 ] == 0 ))) 
		    {
		    	playerScore1=playerScore1+4;
				    ...
				    if( (( this.playBoard[ i ][j] == 0 ) &&
						    ( this.playBoard[ i+1 ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i+2 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i+3 ][ j+3 ] == player2 ))  || (( this.playBoard[ i ][j] == player2 ) &&
						    ( this.playBoard[ i+1 ][ j+1 ] == 0 ) &&
						    ( this.playBoard[ i+2 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i+3 ][ j+3 ] == player2 )) || (( this.playBoard[ i ][j] == player2 ) &&
								    ( this.playBoard[ i+1 ][ j+1 ] == player2 ) &&
				    ...
				    //check opponent 2's
						    ...
						    ( this.playBoard[ i+3 ][ j+3 ] == player2 )) || (( this.playBoard[ i ][j] == player2 ) &&
								    ( this.playBoard[ i+1 ][ j+1 ] == player2 ) &&
								    ( this.playBoard[ i+2 ][ j+2 ] == 0 ) &&
								    ( this.playBoard[ i+3 ][ j+3 ] == 0 )) || (( this.playBoard[ i ][j] == 0 ) &&
						    ( this.playBoard[ i+1 ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i+2 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i+3 ][ j+3 ] == 0 ))) 
				    {
	...
	//    }
	    ...
	    for( int i = 0; i < 3; i++ ){
		for( int j = 0; j < 4; j++ ) {
		    if( ( this.playBoard[ i+3 ][ j ] == player1 ) &&
			( this.playBoard[ i+2 ][ j+1 ] == player1 ) &&
			( this.playBoard[ i+1 ][ j+2 ] == player1 ) &&
			( this.playBoard[ i ][ j+3 ] == player1 ) ) {
		    	playerScore1=playerScore1+10;
		    }
		    else  if( ( this.playBoard[ i+3 ][ j ] == player2 ) &&
					( this.playBoard[ i+2 ][ j+1 ] == player2 ) &&
					( this.playBoard[ i+1 ][ j+2 ] == player2 ) &&
					( this.playBoard[ i ][ j+3 ] == player2 ) ) {
		    	playerScore2=playerScore2+10;
		    }
			...
			//check for unblocking 3's
				    ...
				    ( this.playBoard[ i+2 ][ j+1 ] == player1 ) &&
				    ( this.playBoard[ i+1 ][ j+2 ] == player1 ) &&
				    ( this.playBoard[ i ][ j+3 ] == player1 ))  || (( this.playBoard[ i+3 ][j] == player1 ) &&
...
//check for unblocking 2's
					...
					//check for unblocking 3's
						    ...
						    ( this.playBoard[ i+2 ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i+1 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player2 ))  || (( this.playBoard[ i+3 ][j] == player2 ) &&
						    ( this.playBoard[ i+2 ][ j+1 ] == 0 ) &&
						    ( this.playBoard[ i+1 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+3 ] == player2 )) || (( this.playBoard[ i+3 ][j] == player2 ) &&
								    ( this.playBoard[ i+2 ][ j+1 ] == player2 ) &&
		    ...
		    else {//check for unblocking 2's opponent  
		    	if( (( this.playBoard[ i+3 ][j] == 0 ) &&
						    ...
						    ( this.playBoard[ i ][ j+3 ] == player2 )) || (( this.playBoard[ i+3 ][j] == player2 ) &&
								    ( this.playBoard[ i+2 ][ j+1 ] == player2 ) &&
								    ( this.playBoard[ i+1 ][ j+2 ] == 0 ) &&
								    ( this.playBoard[ i ][ j+3 ] == 0 )) || (( this.playBoard[ i+3 ][j] == 0 ) &&
						    ( this.playBoard[ i+2 ][ j+1 ] == player2 ) &&
						    ( this.playBoard[ i+1 ][ j+2 ] == player2 ) &&
						    ( this.playBoard[ i ][ j+3 ] == 0 ))) 
				    {
     ...
     * false otherwise
     */
    public boolean playPiece( int column , String game_mode,int currentTurn) {
	...
	if( !this.isValidPlay( column ) ) {
		...
		if( this.playBoard[i][column] == 0 ) {
		   // if( this.pieceCount % 2 == 0 ){
			...
			{
				this.playBoard[i][column] = this.currentTurn;
		    	this.pieceCount++;
			}
		    /*} else { 
	...
	try {
	    ...
	    int turn=(this.currentTurn==1)?2:1;
	    output.write( turn + "\r\n");
	    output.close();
